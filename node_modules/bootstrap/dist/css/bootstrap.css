...
.bg-primary {
  background-color: #67AD1E; }

a.bg-primary:hover {
  background-color: #4d8216; }
...
abbr[data-original-title] {
  cursor: help;
  border-bottom: 1px dotted #4B9BDC; }
...
.table {
  ...
  .table > thead > tr > th {
    ...
    border-bottom: 2px solid #17344D; }
...
.nav-tabs {
  ...
  .nav-tabs > li {
    ...
    .nav-tabs > li > a {
      ...
      .nav-tabs > li > a:hover {
        border-color: #9FC1D6 #9FC1D6 #ddd; }
...
.panel-primary {
  ...
  .panel-primary > .panel-heading {
    ...
    .panel-primary > .panel-heading + .panel-collapse > .panel-body {
      border-top-color: #67AD1E; }
    .panel-primary > .panel-heading .badge {
      color: #67AD1E;
      background-color: #fff; }
  .panel-primary > .panel-footer + .panel-collapse > .panel-body {
    border-bottom-color: #67AD1E; }
